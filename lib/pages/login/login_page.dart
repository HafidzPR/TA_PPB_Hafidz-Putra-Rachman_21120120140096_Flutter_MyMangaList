                                            ...
                                            onSubmitted: (value) async {
                                              if (animation.loginButtonOpacity
                                                ...
                                                if (password == '' &&
                                                  ...
                                                  setState(() {
                                                    loginText =
                                                        'Nama Akun atau password kosong';
                                                  });
                                                } else {
                                                  setState(() {
                                                    ...
                                                    if (loginData.result ==
                                                      ...
                                                      setState(() {
                                                        animation.controller
                                                            .forward();
                                                        loginText =
                                                            'Nama Akun atau password salah.';
                                                      });
                                                    }
                                                  } catch (e) {
                                                    setState(() {
                                                      loginText =
                                                          "Tidak bisa melakukan koneksi ke Mangadex :(";
                                                      animation.controller
                                                          .forward();
                                                    });
                                                  }
